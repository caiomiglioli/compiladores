...
class MyNode(NodeMixin):  # Add Node feature   
  ...
  def __init__(self, name, parent=None, id=None, type=None, label=None, children=None, lineno=None, linespan=None):
    ...
    self.info = (self.id,self.label,self.name,self.type,self.parent,self.children)#,self.lineno)
